...
public class CoordinateConverter {
    ...
    private static final double XO = 43; // 기준점 X좌표 (격자 기준)
    private static final double YO = 136; // 기준점 Y좌표 (격자 기준)

    public static GridCoordinate convert(double lat, double lon) {
        ...
        gridCoordinate.nx = (int) Math.floor(ra * Math.sin(theta) + XO + 0.5);
        gridCoordinate.ny = (int) Math.floor(ro - ra * Math.cos(theta) + YO + 0.5);
